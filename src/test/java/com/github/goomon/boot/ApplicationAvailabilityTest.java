...
public class ApplicationAvailabilityTest {
    ...
    void managingApplicationAvailabilityTest() {
        publisher.publishAvailability(ReadinessState.ACCEPTING_TRAFFIC); // print out ACCEPTING_TRAFFIC
        publisher.publishAvailability(ReadinessState.REFUSING_TRAFFIC); // print out REFUSING_TRAFFIC
    }
}
